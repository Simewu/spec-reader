## O-RAN.WG6.AAL-HI_PHY-R004-v07.00.docx

- View in [Reader Mode](https://simewu.com/spec-reader/pages/07-WG6/O-RAN.WG6.AAL-HI_PHY-R004-v07.00.docx).
...
| combOffset | | \bar{k}\_{TC}: transmission comb offset | 3GPP TS 38.211, sec  6.4.1.4.3 |
...
| prach-GuardbandOffse t | \bar{k}: guard offset from k1 (can be derived from the SCS for PRACH and PUSCH and PRACH format) | 3GPP TS 38.211, sec 6.3.3 |
...
| CSI-RS locations Row | row indicating the CSI-RS location in table 7.4.1.5.3-1. Can be used to derive;   * density ? (see also Frequency Density) * cdmType * ports * \bar{k} in the (\bar{k},   \bar{l})-tuple | *Row* signals CSI-RS locations Row |
...
| CSI-RS locations Row | row indicating the CSI-RS location in table 7.4.1.5.3-1. Can be used to derive;   * \bar{l} in the (\bar{k},   \bar{l})-tuple | *Row* signals CSI-RS locations Row |

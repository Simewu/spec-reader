...
rm -rf "$OUTPUT_JEKYLL_DIR/01-TIFG"
rm -rf "$OUTPUT_JEKYLL_DIR/02-WG11"
rm -rf "$OUTPUT_JEKYLL_DIR/03-WG10"
rm -rf "$OUTPUT_JEKYLL_DIR/04-WG9"
rm -rf "$OUTPUT_JEKYLL_DIR/05-WG8"
rm -rf "$OUTPUT_JEKYLL_DIR/06-WG7"
rm -rf "$OUTPUT_JEKYLL_DIR/07-WG6"
rm -rf "$OUTPUT_JEKYLL_DIR/08-WG5"
rm -rf "$OUTPUT_JEKYLL_DIR/09-WG4"
rm -rf "$OUTPUT_JEKYLL_DIR/10-WG3"
rm -rf "$OUTPUT_JEKYLL_DIR/11-WG2"
rm -rf "$OUTPUT_JEKYLL_DIR/12-WG1"
mkdir -p "$OUTPUT_JEKYLL_DIR/01-TIFG"
mkdir -p "$OUTPUT_JEKYLL_DIR/02-WG11"
mkdir -p "$OUTPUT_JEKYLL_DIR/03-WG10"
mkdir -p "$OUTPUT_JEKYLL_DIR/04-WG9"
mkdir -p "$OUTPUT_JEKYLL_DIR/05-WG8"
mkdir -p "$OUTPUT_JEKYLL_DIR/06-WG7"
mkdir -p "$OUTPUT_JEKYLL_DIR/07-WG6"
mkdir -p "$OUTPUT_JEKYLL_DIR/08-WG5"
mkdir -p "$OUTPUT_JEKYLL_DIR/09-WG4"
mkdir -p "$OUTPUT_JEKYLL_DIR/10-WG3"
mkdir -p "$OUTPUT_JEKYLL_DIR/11-WG2"
mkdir -p "$OUTPUT_JEKYLL_DIR/12-WG1"
...
for FILE_PATH in "$INPUT_DIR"/*.md; do
    ...
    "TIFG") TARGET_DIR="$OUTPUT_JEKYLL_DIR/01-TIFG" ;;
    "WG11") TARGET_DIR="$OUTPUT_JEKYLL_DIR/02-WG11" ;;
    "WG10") TARGET_DIR="$OUTPUT_JEKYLL_DIR/03-WG10" ;;
    "WG9") TARGET_DIR="$OUTPUT_JEKYLL_DIR/04-WG9" ;;
    "WG8") TARGET_DIR="$OUTPUT_JEKYLL_DIR/05-WG8" ;;
    "WG7") TARGET_DIR="$OUTPUT_JEKYLL_DIR/06-WG7" ;;
    "WG6") TARGET_DIR="$OUTPUT_JEKYLL_DIR/07-WG6" ;;
    "WG5") TARGET_DIR="$OUTPUT_JEKYLL_DIR/08-WG5" ;;
    "WG4") TARGET_DIR="$OUTPUT_JEKYLL_DIR/09-WG4" ;;
    "WG3") TARGET_DIR="$OUTPUT_JEKYLL_DIR/10-WG3" ;;
    "WG2") TARGET_DIR="$OUTPUT_JEKYLL_DIR/11-WG2" ;;
    "WG1") TARGET_DIR="$OUTPUT_JEKYLL_DIR/12-WG1" ;;
    *) TARGET_DIR="" ;;
    esac
    ...
    CONTENTS=$(echo "$CONTENTS" | sed 's|\(- Download the \[Original Document\]\(.*\)\.\)|\1\n\n---\n\n* toc\n{:toc}|')

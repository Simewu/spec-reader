...
|  |
| --- |
| ![webwxgetmsgimg (7).jpeg](../assets/images/bea03973c631.jpg)O-RAN.WG2.R1AP-R004-v06.00 |
...
7.1.3 Resource structure and methods 34
...
7.4.6 Custom operation without associated resources. 64
...
A.3.5 HTTP based Pull data API 158
...
For the service registration APIas specified in the present document, the MAJOR version field shall be 1, the MINOR version field shall be 1 and the PATCH version field shall be 0 (see clause 4.3.1.1 of 3GPP TS 29.501 [1] for a definition of the version fields). Consequently, the <apiVersion> URI path segment shall be set to "v1".
...
![](../assets/images/7db14aba2010.emf.png)
...
![PlantUML diagram](../assets/images/62bbf0ea65bb.png)
...
![PlantUML diagram](../assets/images/20859a65bd7e.png)
...
![PlantUML diagram](../assets/images/5784ec265a8e.png)
...
![PlantUML diagram](../assets/images/180bef0c0847.png)
...
![](../assets/images/ce9d1e7b80ee.emf.png)
...
![PlantUML diagram](../assets/images/a45920bd9dff.png)
...
![PlantUML diagram](../assets/images/e02625d821f8.png)
...
![PlantUML diagram](../assets/images/0338f0b8c964.png)
...
![PlantUML diagram](../assets/images/9a85a59e5452.png)
...
![Generated by PlantUML](../assets/images/1544fbc91537.png)
...
![PlantUML diagram](../assets/images/1946513cf22b.png)
...
![](../assets/images/158bfc89cf42.emf.png)
...
| --- | --- | --- | --- |
| Resource name | Resource URI | HTTP method | Service Operation |
| All data offers | .../{apiConsumerId}/offers | POST | Create an individual data offer |
| Individual data offer | .../{apiConsumerId}/offers/{dataOfferId} | DELETE | Cancel data offer |
...
Consumer ->> Producer: POST .../{apiConsumerId}/offers (DataOfferInfo)

Producer -->> Consumer: 201 Created (DataOfferInfo)

@enduml

![Generated by PlantUML](../assets/images/fa2f9f367166.png)

Figure 7.6.4.1.1-1: Create data offer operation

The service operation is as follows:

1. The API Consumer shall send an HTTP POST request to the API Producer. The target URI shall identify the resource (.../{apiConsumerId}/offers) under which the new data offer is to be created. The message content shall carry a DataOfferInfo structure.
...
Consumer ->> Producer: DELETE .../{apiConsumerId}/offers/{dataOfferId}

Producer -->> Consumer: 204 No Content

@enduml

![Generated by PlantUML](../assets/images/f2e359dac62d.png)

Figure 7.6.4.2.1-1: Cancel data offer operation.

The service operation is as follows:

1. The API Consumer shall send an HTTP DELETE request to the API Producer. The target URI shall identify the resource (.../{apiConsumerId}/offers/{dataOfferId}).
2. The API Producer shall return the HTTP DELETE response. On success, "204 No Content" shall be returned. On failure, the appropriate error code shall be returned, and the message content may contain additional error information.
...
![Generated by PlantUML](../assets/images/6d14fe7a036f.png)
...
Resource URI: **{apiRoot}/data-offer/<apiVersion>/{apiConsumerId}/offers**
...
| apiConsumerId | Identifier of API Consumer (See NOTE). |
| NOTE: If an rApp is the API Consumer, the apiConsumerId is equivalent to rAppId. No other consumer types are specified in the present document. | |
...
Resource URI: **{apiRoot}/data-offer /<apiVersion>/{apiConsumerId}/offers/{dataOfferId}**
...
![Generated by PlantUML](../assets/images/1af4b2e0b3d0.png)
...
![Generated by PlantUML](../assets/images/ae9e15dccbe5.png)
...
![Generated by PlantUML](../assets/images/a604e3c30c52.png)
...
![Generated by PlantUML](../assets/images/98008e679335.png)
...
![](../assets/images/d98416bda3c6.emf.png)
...
![PlantUML diagram](../assets/images/ffd61f2b0b0e.png)
...
![PlantUML diagram](../assets/images/3966bd4d27ca.png)
...
![Generated by PlantUML](../assets/images/81f01736e7c6.png)
...
![PlantUML diagram](../assets/images/fd9d0b98788d.png)
...
![Generated by PlantUML](../assets/images/1b8106acfe29.png)
...
![Generated by PlantUML](../assets/images/aa2d6d989524.png)
...
![Generated by PlantUML](../assets/images/7431bbf268e7.png)
...
![](../assets/images/928d4ee37505.png)
...
![PlantUML diagram](../assets/images/61d1e5a1283f.png)
...
![PlantUML diagram](../assets/images/27f1b6bcecf1.png)
...
![PlantUML diagram](../assets/images/2a770edd881a.png)
...
![PlantUML diagram](../assets/images/2edad991e430.png)
...
![PlantUML diagram](../assets/images/2dd65eb354ae.png)
...
![](../assets/images/aaf661a7109d.emf.png)
...
![PlantUML diagram](../assets/images/a22b91e2ea1f.png)
...
![PlantUML diagram](../assets/images/622095b1c18b.png)
...
![PlantUML diagram](../assets/images/f25297ca8af8.png)
...
![PlantUML diagram](../assets/images/cc1b9609430a.png)
...
![](../assets/images/7e5b965a6e96.emf.png)
...
![Generated by PlantUML](../assets/images/c9f5a49796d8.png)
...
![](../assets/images/01ad36a498b0.emf.png)
...
![PlantUML diagram](../assets/images/7ec4ea0ef9f5.png)
...
![PlantUML diagram](../assets/images/6fee60846381.png)
...
![PlantUML diagram](../assets/images/131b64949731.png)
...
![](../assets/images/7078db1ad7fd.png)
...
| Service registration API | 1.1.0 | 1.3.0 |
...
| --- | --- | --- |
| API name | API version | CAPIF OpenAPI version |
| Service discover API | 1.1.0 | 1.3.0 |
...
| --- | --- | --- |
| API name | API version | CAPIF OpenAPI version |
| Service events subscription API | 1.1.0 | 1.3.0 |
...
$ref: '#/components/schemas/DmeTypeDefinitiontion'
...
description: 'These configuration will be applied if KAFKA\_DATA\_STREAM is selected as delivery method'
